...
SF_PASSWORD = os.getenv('SF_PASSWORD', os.getenv('SNOWFLAKE_PASSWORD', 'AutoTask@2026StrongPass!'))
SF_AUTHENTICATOR = os.getenv('SF_AUTHENTICATOR', os.getenv('SNOWFLAKE_AUTHENTICATOR', 'snowflake'))
